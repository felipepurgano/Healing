...
def home(request):
    if request.method == "GET":
        ...
        especialidades_filtrar = request.GET.getlist('especialidades') #getlist busca mais de um valor no banco, somente o get busca apenas o último valor
...
# TODO: Fazer a validação de segurança no restante do código
# TODO: Desenvolver a dashboard do médico