...
def cadastro_medico(request):
    if request.method == "GET":
        ...
        # Dados da esquerda precisam estar iguais os definidos na MODEL e da direira o que foi definido acima.
    ...
    # Essa def está instanciada dentro das models, onde criada a função.
def cadastro_medico(request):
